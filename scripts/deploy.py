...
def main():
    ...
    # --- NO IMU FLAG (ADDED HERE) ---
    parser.add_argument("--no_imu", action="store_true",
                        help="Disable IMU and use constant 0 for gyro and [0,0,-1] for gravity (debugging)")
    ...
    # Print if IMU debugging is enabled
    if args.no_imu:
        print(f"[DEBUG] --no_imu flag is ACTIVE. Mocking IMU sensor data.")
...
# ==========================================
    ...
    if len(entries) > 1:
        ...
        with open(csv_path, 'w', newline='') as f:
            ...
            # Build Header (Use dot notation: entries[0].actual_pos)
            ...
            # Write Data (Use dot notation for entry properties)
